...
public class Particle implements IParticle
{
    ...
    /**
     * Konstruktor für Objekte der Klasse Particle
     ...
     */
    public Particle(Room room, Mesh mesh, TurtleColor color, Vector3 position, Vector3 rotation, Vector3 scale, Vector3 velocity, Vector3 gravity, Double lifeTime)
    {
        _room = room;
        _mesh = new Mesh(mesh);
    ...
    /**
     * Generiert die Modelmatrix aller Transformationen auf dem Particle
     * @return Modelmatrix
     */
