...
/**
 * Einsammelbarer Schlüssel, der Türen der gleichen Farbe öffnen kann
 * 
 * @author Lasse Huber-Saffer
 * @version 03.01.2022
 */
public class Key implements IDynamicGameObject, ICollisionListener
{
    // Parent-Raum
    private Room _room;
    ...
    /**
     * Konstruktor für Key mit Position und Meshes
     ...
     */
    public Key(Vector3 position, TurtleColor color, Room room, HashMap<String, Mesh> entityMeshes, SoundEngine soundEngine)
    {
        _room = room;
    ...
    public void onCollision(ICollider self, ICollider other)
    {
        ...
        if(other.getLayer() == PhysicsLayer.PLAYER)
        {
            ...
            // Schlüsselfarbe beim Spieler eintragen
            if(!player.acquiredKeyColors.contains(_color))
            {
                player.acquiredKeyColors.add(_color);
            }
